...
Также есть декоратор `@slot_object.plugin_template`, в этом случае в него можно потом заворачивать в


Надо определиться, как регистрировать много мутаций в качестве одного плагина
